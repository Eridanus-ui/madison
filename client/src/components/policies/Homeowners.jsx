...
import { Home, Shield, DollarSign, FileText, Phone } from "lucide-react";
    ...
    <div className="max-w-full md:max-w-2xl lg:max-w-4xl mx-auto p-4 md:p-6 bg-white shadow-lg rounded-lg max-h-[75vh] overflow-y-auto custom-scrollbar">
      ...
      <header className="mb-6 md:mb-8 text-center">
        ...
        <h2 className="text-md md:text-xl text-gray-600">
          Comprehensive Homeowners Insurance Policy
        </h2>
      </header>
      ...
      <section className="mb-6 md:mb-8">
        <h3 className="text-xl md:text-2xl font-semibold text-blue-700 mb-4 flex items-center">
          <Home className="mr-2 w-6 h-6 text-blue-700" /> Policy Details
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-100 p-4 rounded-md">
          <div>
            ...
            <p className="text-sm md:text-base">HOME-2023-789012</p>
          </div>
          <div>
            <p className="font-medium text-sm md:text-base">Effective Date:</p>
            <p className="text-sm md:text-base">June 1, 2023</p>
          </div>
          <div>
            <p className="font-medium text-sm md:text-base">Expiration Date:</p>
            <p className="text-sm md:text-base">May 31, 2024</p>
          </div>
          <div>
            <p className="font-medium text-sm md:text-base">Policyholder:</p>
            <p className="text-sm md:text-base">Jane Smith</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-6 md:mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 text-sm md:text-base">
          <li>Dwelling Coverage: $500,000</li>
          <li>Personal Property Coverage: $100,000</li>
          <li>Liability Coverage: $300,000</li>
          <li>Loss of Use Coverage: $50,000</li>
          <li>Medical Payments to Others: $5,000</li>
        </ul>
      </section>
      ...
      <section className="mb-6 md:mb-8">
        ...
        <p className="text-sm md:text-base mb-2">Annual Premium: $1,800</p>
        <p className="text-sm md:text-base mb-2">Monthly Payment: $150</p>
      ...
      <section className="mb-6 md:mb-8">
        ...
        <div className="space-y-4 text-sm md:text-base">
          ...
          <p>
            4. <strong>Exclusions:</strong> Coverage does not extend to floods,
            earthquakes, or intentional damage.
          </p>
          <p>
